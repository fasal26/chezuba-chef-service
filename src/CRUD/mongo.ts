...
export default class MongoCRUD {
    ...
    public async aggregate(model: keyof typeof main_db, f: object, agg:string) {
        let result = await this.db[model].aggregate(aggregations[agg](f))
        return result
    }
